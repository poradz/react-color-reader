...
export const InputInstant = (props) => {
      return (
      <div className="cloud-big"> 
        <input 
        onChange={props.onChange} 
        type="text" 
        ref={ props.MyColorInst }
        name="color"
        className="input-instant"
        placeholder="Type color in rgb, hex or hsl for instant result!"
...
InputInstant.propTypes = {
  MyColorInst: PropTypes.func
}
